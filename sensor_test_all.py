#!/usr/bin/env python3
"""Test all four ultrasonic sensors simultaneously. Prints readings every 0.3s."""
...
sensors = {
    ...
    "Back":  DistanceSensor(trigger=9,  echo=11, max_distance=2),
}

print("Reading all 4 sensors. Ctrl-C to stop.\n")
try:
    while True:
        parts = []
